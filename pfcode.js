...
*/
	...
	addon_ui +=
		'<td><input type=checkbox name=pfucase id=pfucase checked><label for=pfucase>' +
		STRING_WIKICODE_UPPERCASE +
		'</label><td>';
	addon_ui += '</table>';
	addon_ui +=
		'<textarea name=pfcode id=pfcode cols=32 rows=4 style="font-size:9pt;" onfocus="this.select();"></textarea><br>';
